...
import { okrsQ42025 } from "@/data/q4-2025";
import { strategyInfo } from "@/data/initiatives";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Compass, Star } from "lucide-react";

export default function OKRsQ42025() {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-foreground">OKRs Q4 2025</h1>
        <p className="text-muted-foreground">Objetivos y Resultados Clave para TMD Mobile</p>
      </div>
